...
class Graph(object):
    def __init__(self, name=None): # fold>>
    ...
    def _registerInfoset(self, infoset): # fold>>
        ...
        # <<fold
    def deleteInfoset(self, infoset): # fold>>
        dimensionality = infoset.dimensionality()
        while infoset in self._infosets[dimensionality]:
            self._infosets[dimensionality].remove(infoset)
